...
export async function POST(
  ...
  try {
    ...
    console.log(
      'POST /api/organization/[id]/funnels/[funnelId]/files/[fileId]/detach'
    );
    ...
    const apiUrl = `${process.env.AIGURO_API_BASE_URL}/api/api/organizations/${organizationId}/funnels/${funnelId}/files/${fileId}/detach`;
    ...
    console.error(
      'Error in POST /api/organization/[id]/funnels/[funnelId]/files/[fileId]/detach:',
      error
    );
    return NextResponse.json(
      {
