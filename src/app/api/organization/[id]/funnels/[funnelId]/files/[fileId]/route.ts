...
export async function DELETE(
  ...
  try {
    ...
    console.log(
      'DELETE /api/organization/[id]/funnels/[funnelId]/files/[fileId]'
    );
    ...
    const apiUrl = `${process.env.AIGURO_API_BASE_URL}/api/api/organizations/${organizationId}/funnels/${funnelId}/files/${fileId}`;
    ...
    console.error(
      'Error in DELETE /api/organization/[id]/funnels/[funnelId]/files/[fileId]:',
      error
    );
    return NextResponse.json(
      {
