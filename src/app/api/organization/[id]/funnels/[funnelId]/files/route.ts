...
export async function GET(
  ...
  try {
    const { id: organizationId, funnelId } = await params;
    const { searchParams } = new URL(request.url);
    const category = searchParams.get('category');

    console.log('GET /api/organization/[id]/funnels/[funnelId]/files');
    ...
    let apiUrl = `${process.env.AIGURO_API_BASE_URL}/api/api/organizations/${organizationId}/funnels/${funnelId}/files`;
    ...
    console.error(
      'Error in GET /api/organization/[id]/funnels/[funnelId]/files:',
      error
    );
    return NextResponse.json(
      {
...
export async function POST(
  ...
  try {
    ...
    console.log('POST /api/organization/[id]/funnels/[funnelId]/files');
    console.log('Organization ID:', organizationId);
    console.log('Funnel ID:', funnelId);
    ...
    // Строим URL для внешнего API
    const apiUrl = `${process.env.AIGURO_API_BASE_URL}/api/api/organizations/${organizationId}/funnels/${funnelId}/files`;
    console.log('External API URL:', apiUrl);
    ...
    console.error(
      'Error in POST /api/organization/[id]/funnels/[funnelId]/files:',
      error
    );
    return NextResponse.json(
      {
