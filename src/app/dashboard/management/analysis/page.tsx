...
export default function AnalysisPage() {
  ...
  const [settings, setSettings] = useState<AnalysisSettings>({
    parameters: [
      ...
      },
      {
        ...
        type: 'Числовой',
        instruction: 'Номер телефона клиента',
        possibleValues: [],
        useBehaviorScenarios: false
      },
      {
      ...
      },
      {
        ...
        name: 'product',
        type: 'Текстовый',
        instruction: 'Наименование и цена товара',
        possibleValues: [
          'Роза 500рублей',
          'Пион 300 рублей',
          'Гвоздика 200 рублей',
          'Гладиолус 250 рублей',
          'Хризантема 400 рублей'
        ],
  ...
  const [activeTab, setActiveTab] = useState<'parameters' | 'prompt'>('prompt');
  ...
  useEffect(() => {
    ...
    try {
      const savedDialogsKey = 'analysis-dialogs';
      ...
      <div className='space-y-6'>
        ...
        <div className='flex items-center justify-between'>
          <div className='flex items-center'>
            ...
            <div>
              <h1 className='text-2xl font-bold'>Анализ и отчеты РОП</h1>
              <p className='text-muted-foreground'>
                Аналитика для руководителей отдела продаж
              </p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Настройка параметров и промпта для анализа данных
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs
            ...
            >
              ...
              <TabsContent value='parameters' className='space-y-4'>
                <div className='space-y-6'>
                  <p className='text-muted-foreground'>
                    Настройте параметры для сбора и анализа данных
                  </p>
                    ...
                    <div className='flex flex-col'>
                      ...
                      <div className='border-b p-4'>
                        ...
                        <Textarea
                          ...
                          placeholder='Введите промпт для ассистента аналитики...'
