...
export default function FollowUpMessagesPage() {
  ...
  const sendMessage = async () => {
    ...
    setTimeout(() => {
      const assistantMessage: ChatMessage = {
        ...
        text: `Здравствуйте, ${userMessageText.includes('Иван') ? 'Иван' : 'клиент'}! Напоминаем о вашем интересе к нашему продукту. Хотели бы вы узнать больше информации или готовы обсудить следующие шаги? С уважением, ваш менеджер.`,
        sender: 'assistant',
        timestamp: Date.now()
      };
  ...
  useEffect(() => {
    ...
    try {
      const savedDialogsKey = 'follow-up-messages-dialogs';
      ...
      <div className='space-y-6'>
        ...
        {/* <Card>
          <CardHeader>
            ...
            <CardDescription>
              Базовые настройки для автоматических сообщений
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Активировать отправку автоматических сообщений клиентам
                  </p>
                </div>
                <Switch
                  id="enable-followup"
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="space-y-2">
                  <Label htmlFor="followup-count">Количество сообщений</Label>
                  <Input
                    id="followup-count"
                    type="number"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Настройка промпта и параметров для генерации сообщений
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs
            ...
            >
              ...
              <TabsContent value='parameters' className='space-y-4'>
                <div className='space-y-6'>
                  <p className='text-muted-foreground'>
                    Настройте параметры для генерации follow-up сообщений
                  </p>

                  {/* Список существующих параметров */}
                  <div className='space-y-4'>
                    <h3 className='text-lg font-medium'>Параметры сообщений</h3>
